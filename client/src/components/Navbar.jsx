...
const Navbar = ({ toggleSidebar }) => {
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-slate-200/50 px-6 h-16 flex items-center justify-between shrink-0">
      ...
      {/* Middle Area: High Fidelity Stats Integration */}
      {isCalendar && calendarStats && (
        <div className="hidden md:flex items-center gap-6 px-6 py-2 bg-white/40 backdrop-blur-md rounded-2xl border border-white/60 flex-1 max-w-lg mx-8 animate-in fade-in slide-in-from-top-2 duration-700 shadow-sm ring-1 ring-slate-200/20 group/stats">
           <div className="flex items-center gap-2.5 transition-all duration-300 hover:scale-105 group/item">
              <div className="w-7 h-7 bg-emerald-500/10 text-emerald-600 rounded-lg flex items-center justify-center shadow-[0_0_15px_rgba(16,185,129,0.1)] group-hover/item:bg-emerald-500 group-hover/item:text-white transition-colors">
                 <Check className="h-3.5 w-3.5" strokeWidth={3} />
              </div>
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest font-outfit">
                Present <span className="text-slate-900 ml-1.5 bg-slate-100 px-2 py-0.5 rounded-md">{calendarStats.present}</span>
              </p>
           </div>
           ...
           <div className="flex items-center gap-2.5 transition-all duration-300 hover:scale-105 group/item">
              <div className="w-7 h-7 bg-yellow-400/20 text-yellow-600 rounded-lg flex items-center justify-center shadow-[0_0_15px_rgba(250,204,21,0.1)] group-hover/item:bg-yellow-500 group-hover/item:text-white transition-colors">
                 <AlertCircle className="h-3.5 w-3.5" />
              </div>
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest font-outfit">
                Incomplete <span className="text-slate-900 ml-1.5 bg-slate-100 px-2 py-0.5 rounded-md">{calendarStats.incomplete}</span>
              </p>
           </div>
           ...
           <div className="flex items-center gap-2.5 transition-all duration-300 hover:scale-105 group/item">
              <div className="w-7 h-7 bg-rose-500/10 text-rose-600 rounded-lg flex items-center justify-center shadow-[0_0_15px_rgba(244,63,94,0.1)] group-hover/item:bg-rose-500 group-hover/item:text-white transition-colors">
                 <X className="h-3.5 w-3.5" strokeWidth={3} />
              </div>
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest font-outfit">
                Absent <span className="text-slate-900 ml-1.5 bg-slate-100 px-2 py-0.5 rounded-md">{calendarStats.absent}</span>
              </p>
           </div>
        </div>
      )}
